    ...
    <div class="container">
      ...
      <div class="container">
        ...
        <div class="field">
          ...
          <p class="control has-icons-left">
            <input class="input" type="text" id="game_salt_input" placeholder="Salt" value="0000000000000000000fd438478cd50a858def3b606d43dfe12a22144f3a5f1b">
      ...
      <div class="container">
        <table class="table is-striped is-fullwidth is-hoverable is-narrow" style="display:table">
          ...
          <tbody id="game_verify_table"><tr class="is-first">
            <td>6d9b3f1db5b6d10b48d38c52888f71c89e7f9183181eaf91731af0d744813219</td>
            <td class="is-over-median">156.45</td></tr></tbody>
        </table>
      </div>
</div>
